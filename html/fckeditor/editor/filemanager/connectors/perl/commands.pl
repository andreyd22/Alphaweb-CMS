...
eval("use File::Copy;");
	...
	if($new_fname && !&ErrAuth()) {
		...
		$sOriginalFileName = $sFileName;
	        #$sFileName=~tr/ ÈÆÑÉÅÌÖÜÛÃÓÇÒØÁÞÎÏÍÊÄÔÙÚÂßËÕÐÝÀ×¸èæñéåìöüûãóçòøáþîïíêäôùúâÿëõðýà÷¨/_qwertyuiop__asdfghjkl__zxcvbnm___qwertyuiop__asdfghjkl__zxcvbnm___/;

		print "content-type:text/html\r\n\r\n";
		#print qq[$sServerDir  $sFileName $currentFolder]; exit;
		$iCounter = 0;
		while(1) {
			...
			if(-e $sFilePath) {
				...
				#print qq["$img_dir/$new_fname","$sFilePath"]; exit;
