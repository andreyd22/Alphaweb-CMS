...
HTMLArea.Config = function () {
        ...
        // URL-s
//      this.imgURL = "http://andreyd.h10.ru/htmlarea/images/";
//      this.popupURL = "http://andreyd.h10.ru/htmlarea/popups/";
        this.imgURL = "/";
        ...
        this.btnList = {
                ...
                justifyfull: [ "Justify Full", "/htmlarea/images/ed_align_justify.gif", false, function(e) {e.execCommand("justifyfull");} ],
                insertorderedlist: [ "Ordered List", "/htmlarea/images/ed_list_num.gif", false, function(e) {e.execCommand("insertorderedlist");} ],
                insertunorderedlist: [ "Bulleted List", "/htmlarea/images/ed_list_bullet.gif", false, function(e) {e.execCommand("insertunorderedlist");} ],
                outdent: [ "Decrease Indent", "/htmlarea/images/ed_indent_less.gif", false, function(e) {e.execCommand("outdent");} ],
                indent: [ "Increase Indent", "/htmlarea/images/ed_indent_more.gif", false, function(e) {e.execCommand("indent");} ],
                forecolor: [ "Font Color", "/htmlarea/images/ed_color_fg.gif", false, function(e) {e.execCommand("forecolor");} ],
                hilitecolor: [ "Background Color", "/htmlarea/images/ed_color_bg.gif", false, function(e) {e.execCommand("hilitecolor");} ],
                inserthorizontalrule: [ "Horizontal Rule", "/htmlarea/images/ed_hr.gif", false, function(e) {e.execCommand("inserthorizontalrule");} ],
                createlink: [ "Insert Web Link", "/htmlarea/images/ed_link.gif", false, function(e) {e.execCommand("createlink", true);} ],
                insertimage: [ "Insert Image", "/htmlarea/images/ed_image.gif", false, function(e) {e.execCommand("insertimage");} ],
                inserttable: [ "Insert Table", "/htmlarea/images/insert_table.gif", false, function(e) {e.execCommand("inserttable");} ],
                htmlmode: [ "Toggle HTML Source", "/htmlarea/images/ed_html.gif", true, function(e) {e.execCommand("htmlmode");} ],
                popupeditor: [ "Enlarge Editor", "/htmlarea/images/fullscreen_maximize.gif", true, function(e) {e.execCommand("popupeditor");} ],
                about: [ "About this editor", "/htmlarea/images/ed_about.gif", true, function(e) {e.execCommand("about");} ],
                showhelp: [ "Help using editor", "/htmlarea/images/ed_help.gif", true, function(e) {e.execCommand("showhelp");} ],
                undo: [ "Undoes your last action", "/htmlarea/images/ed_undo.gif", false, function(e) {e.execCommand("undo");} ],
                redo: [ "Redoes your last action", "/htmlarea/images/ed_redo.gif", false, function(e) {e.execCommand("redo");} ],
                cut: [ "Cut selection", "/htmlarea/images/ed_cut.gif", false, cut_copy_paste ],
                copy: [ "Copy selection", "/htmlarea/images/ed_copy.gif", false, cut_copy_paste ],
                paste: [ "Paste from clipboard", "/htmlarea/images/ed_paste.gif", false, cut_copy_paste ]
        };
...
function wordDel(){
        document.all.foo.innerHTML = doCleanCode(document.all.foo.innerHTML);
}
...
//                html += "<style>" + editor.config.pageStyle + "</style>\n";
                ...
                html += "</body>\n";
                html += "</html>";
                //Очищаем нафиг он вордовых тегов
//              html=doCleanCode(html);
//              alert(html);
                doc.write(html);
                doc.close();
